...
public class MainMethod {
    public static void main(String[] args) {
       ...
       treatment.addMedication(new Medication("Vitamin C",100, 35.5, LocalDate.now().plusYears(1), Usage.VITAMINS, Type.DROPS, new AdministrationMethod(3, Arrays.asList(TimeOfDay.MORNING,TimeOfDay.AFTERNOON),Boolean.TRUE)));
        ...
        treatment.addMedication(new Medication("Vitamin D",100, 35.5, LocalDate.now().plusYears(1), Usage.VITAMINS, Type.DROPS, new AdministrationMethod(3, Arrays.asList(TimeOfDay.MORNING,TimeOfDay.AFTERNOON, TimeOfDay.EVENING),Boolean.FALSE)));
